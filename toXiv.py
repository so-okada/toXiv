...
parser = argparse.ArgumentParser(
    description='arXiv daily new submissions by toots, '
    'abstracts by replies, '
    'cross-lists by boosts, '
    'and replacements by toots and boosts.')
...
parser.add_argument("--mode",
                    ...
                    type=int,
                    default='0',
                    help='1 for mastodon and 0 for stdout only')
